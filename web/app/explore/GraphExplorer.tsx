...
const nodes = [
  { id: 'P-0001', x: 50, y: 50, size: 22, color: '#007cf0', cases: 6, edges: 5 },
  { id: 'P-0024', x: 27, y: 28, size: 14, color: '#00C2CB', cases: 3, edges: 3 },
  { id: 'P-0076', x: 74, y: 30, size: 15, color: '#ff0080', cases: 4, edges: 4 },
  { id: 'P-0112', x: 24, y: 70, size: 13, color: '#00C853', cases: 1, edges: 2 },
  { id: 'P-0130', x: 75, y: 72, size: 14, color: '#f9cb28', cases: 2, edges: 3 },
  { id: 'P-0219', x: 8, y: 48, size: 10, color: '#00C2CB', cases: 1, edges: 1 },
  { id: 'P-0304', x: 91, y: 50, size: 11, color: '#ff0080', cases: 2, edges: 1 },
];
